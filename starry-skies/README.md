...
This is a sample template for starry-skies - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name starry-skies --query 'Stacks[].Outputs'
```
